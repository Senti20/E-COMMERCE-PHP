...
$cat_query = "SELECT * FROM categories WHERE category_id = :id AND status = 'active'";
...
$pageTitle = $category['category_name'] . " - Products";
?>
...
<div class="d-flex flex-column justify-content-center align-items-center py-5 customer-hero"
    ...
    <div class="container hero-content">
        <h1 class="fw-bold display-5"><?php echo $category['category_name']; ?></h1>
...
<div class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-<?php echo $category['color']; ?> border-2 product-card">
                ...
                <div class="card-body d-flex flex-column">
                    <span class="badge bg-<?php echo $category['color']; ?> mb-2 align-self-start"><?php echo $category['category_name']; ?></span>
                    ...
                    <div class="specs mb-3">
                        ...
                        <div class="d-flex align-items-center mb-1">
                            <i class="bi bi-check-circle-fill text-<?php echo $category['color']; ?> me-2" style="font-size: 0.8rem;"></i>
                    ...
                    <a href="cart.php?action=add&id=<?php echo $product['product_id']; ?>&qty=1" 
                       class="btn btn-<?php echo $category['color']; ?>">
    ...
    <div class="empty-state">
        ...
        <h4 class="mt-3 text-muted">No products found in this category</h4>
        <p class="text-muted">Check back later for new arrivals!</p>
        <a href="products.php" class="btn btn-primary mt-2">Browse Other Categories</a>
    </div>
    <?php endif; ?>
</div>

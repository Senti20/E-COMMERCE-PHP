...
<div class="d-flex flex-column justify-content-center align-items-center py-5 customer-hero"
    ...
    <div class="container hero-content">
        <h1 class="fw-bold display-5">Motherboards</h1>
        <p class="lead">ASUS, MSI, Gigabyte & more for every build</p>
...
<div class="container py-5">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-<?php echo $category['color'] ?? 'info'; ?> border-2 product-card">
                ...
                <div class="card-body d-flex flex-column">
                    <span class="badge bg-<?php echo $category['color'] ?? 'info'; ?> mb-2 align-self-start">Motherboard</span>
    ...
    <div class="empty-state">
        <i class="bi bi-motherboard display-1 text-muted"></i>
        <h4 class="mt-3 text-muted">No motherboard products available</h4>
        <p class="text-muted">Check back later for new motherboard arrivals!</p>

...
<div class="d-flex flex-column justify-content-center align-items-center py-5 customer-hero"
    ...
    <div class="container hero-content">
        <h1 class="fw-bold display-5">Storage (SSD/HDD)</h1>
        <p class="lead">NVMe SSDs & Hard Drives for fast storage solutions</p>
...
<div class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-<?php echo $category['color'] ?? 'dark'; ?> border-2 product-card">
                ...
                <div class="card-body d-flex flex-column">
                    <span class="badge bg-<?php echo $category['color'] ?? 'dark'; ?> mb-2 align-self-start">Storage</span>
                    ...
                    <div class="specs mb-3">
                        ...
                        <div class="d-flex align-items-center mb-1">
                            <i class="bi bi-check-circle-fill text-<?php echo $category['color'] ?? 'dark'; ?> me-2" style="font-size: 0.8rem;"></i>
                    ...
                    <a href="cart.php?action=add&id=<?php echo $product['product_id']; ?>&qty=1" 
                       class="btn btn-<?php echo $category['color'] ?? 'dark'; ?>">
    ...
    <div class="empty-state">
        ...
        <h4 class="mt-3 text-muted">No storage products available</h4>
        <p class="text-muted">Check back later for new SSD/HDD arrivals!</p>

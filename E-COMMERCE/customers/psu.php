...
<div class="d-flex flex-column justify-content-center align-items-center py-5 customer-hero"
    ...
    <div class="container hero-content">
        <h1 class="fw-bold display-5">Power Supplies (PSU)</h1>
        <p class="lead">Reliable power for your system from Corsair, Seasonic, EVGA</p>
...
<div class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-<?php echo $category['color'] ?? 'warning'; ?> border-2 product-card">
                ...
                <div class="card-body d-flex flex-column">
                    <span class="badge bg-<?php echo $category['color'] ?? 'warning'; ?> text-dark mb-2 align-self-start">PSU</span>
                    ...
                    <div class="specs mb-3">
                        ...
                        <div class="d-flex align-items-center mb-1">
                            <i class="bi bi-check-circle-fill text-<?php echo $category['color'] ?? 'warning'; ?> me-2" style="font-size: 0.8rem;"></i>
                    ...
                    <a href="cart.php?action=add&id=<?php echo $product['product_id']; ?>&qty=1" 
                       class="btn btn-<?php echo $category['color'] ?? 'warning'; ?>">
    ...
    <div class="empty-state">
        ...
        <h4 class="mt-3 text-muted">No power supply products available</h4>
        <p class="text-muted">Check back later for new PSU arrivals!</p>

...
<div class="d-flex flex-column justify-content-center align-items-center py-5 customer-hero"
    ...
    <div class="container hero-content">
        <h1 class="fw-bold display-5">Processors (CPU)</h1>
        <p class="lead">High-performance CPUs for gaming, productivity, and content creation</p>
...
<div class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-<?php echo $category['color'] ?? 'success'; ?> border-2 product-card">
                ...
                <div class="card-body d-flex flex-column">
                    <span class="badge bg-<?php echo $category['color'] ?? 'success'; ?> mb-2 align-self-start">CPU</span>
                    ...
                    <div class="specs mb-3">
                        ...
                        <div class="d-flex align-items-center mb-1">
                            <i class="bi bi-check-circle-fill text-<?php echo $category['color'] ?? 'success'; ?> me-2" style="font-size: 0.8rem;"></i>
                    ...
                    <a href="cart.php?action=add&id=<?php echo $product['product_id']; ?>&qty=1" 
                       class="btn btn-<?php echo $category['color'] ?? 'success'; ?>">
    ...
    <div class="empty-state">
        ...
        <h4 class="mt-3 text-muted">No CPU products available</h4>
